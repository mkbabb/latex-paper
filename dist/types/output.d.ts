export type PaperNestedBlock = string | MathBlockData | FigureBlock | CodeBlock;
 ...
 */
export type ContentBlock = string | MathBlockData | TheoremBlock | FigureBlock | CodeBlock | ProofBlock;
...
export interface PaperLabelInfo {
    ...
    type: "section" | "theorem" | "definition" | "lemma" | "proposition" | "corollary" | "aside" | "example" | "figure" | "equation";
